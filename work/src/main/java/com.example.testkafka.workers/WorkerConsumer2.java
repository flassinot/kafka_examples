...
public class WorkerConsumer2 {
  ...
  private final Logger logger = LoggerFactory.getLogger(WorkerConsumer2.class);
  ...
  public void listen(ConsumerRecord<String, Work> record) throws InterruptedException {
    logger.info("Worker 2 received: " + record.value() + " on Partition " + record.partition());
    logger.info("Worker 2 result in Fahrenheit: " + computeService.convertToFahrenheit(
